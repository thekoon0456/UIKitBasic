...
final class CodeViewController: UIViewController {
    ...
    private lazy var heightStackView: UIStackView = {
        ...
        stackView.addSubview(heightLabel)
        stackView.addSubview(heightTextfield)
        return stackView
    }()
    ...
    private lazy var weightStackView: UIStackView = {
        ...
        stackView.addSubview(weightTextfield)
        return stackView
    }()
    ...
    private lazy var wholeStackView: UIStackView = {
        ...
        stackView.addSubview(heightStackView)
        stackView.addSubview(weightStackView)
        return stackView
    }()
